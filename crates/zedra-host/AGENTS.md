...
- For agent actors and `zedra setup` flows, follow [Managed Agents](../../docs/MANAGED_AGENTS.md), especially [Setup Flow](../../docs/MANAGED_AGENTS.md#setup-flow-zedra-setup).
