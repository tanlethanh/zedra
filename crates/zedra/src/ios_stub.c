...
__attribute__((weak)) void ios_open_webview(unsigned int callback_id, const char *config_json) {}
__attribute__((weak)) void ios_close_webview(void) {}
__attribute__((weak)) void ios_eval_webview_js(const char *js) {}
